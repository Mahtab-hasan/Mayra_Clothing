        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-6 md:mb-0 md:mr-8 md:w-1/2">
            ...
            <p className="text-lg mb-6">
              Mayra Clothing has been a proud pioneer in premium DTF printed apparel in Bangladesh since 2024. We are dedicated to offering our esteemed customers not just high-quality fashion, but an experience that seamlessly blends style, comfort, and exceptional durability, all at genuinely affordable prices.
            </p>
            <a
              href="#contact"
